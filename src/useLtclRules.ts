...
// The LTCL submission rules, stored as a single editable text blob in Firestore
// (config/ltclRules). Admins can change it in place; everyone else reads it.
// Lines ending in ":" render as section headings, the rest as rules.
