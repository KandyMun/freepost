...
const lt = {
  ...
  ltcl_list_sort_placement: 'Pagal vietą',
  ltcl_list_sort_enjoyment: 'Pagal enjoyment',
  ...
  ltcl_edit_provisional: 'Preliminari pozicija',
  ltcl_edit_provisional_hint: 'Prideda žurnalo įrašą, kad lygiui dar trūksta nuomonių ir jo pozicija sąraše gali keistis.',
